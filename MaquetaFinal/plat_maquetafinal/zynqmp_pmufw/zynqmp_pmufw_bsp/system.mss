...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = MYIP_MOTORDC_DIR
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MYIP_MOTORDC_DIR_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = MY_IP_CONTADOR_21_22
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MY_IP_CONTADOR_21_22_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = MY_IP_FILTRO_21_22
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MY_IP_FILTRO_21_22_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = MY_IP_HALL_21_22
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MY_IP_HALL_21_22_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = MY_IP_HC_SR04
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MY_IP_HC_SR04_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = MY_IP_STEPPER
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MY_IP_STEPPER_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = my_ip_temperatura
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = my_ip_temperatura_0
END
