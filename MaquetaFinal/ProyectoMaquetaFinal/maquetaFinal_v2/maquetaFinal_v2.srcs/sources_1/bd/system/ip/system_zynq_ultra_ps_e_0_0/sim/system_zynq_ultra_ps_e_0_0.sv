...
import "DPI-C" function void ps8_init_c_model();
 ...
 import "DPI-C" function void ps8_set_input_pl_ps_apugic_irq(input int pinIndex, input int pinVlaue);
 always@(posedge pl_ps_apugic_irq[0])
 begin
  ps8_set_input_pl_ps_apugic_irq(0,1);
end

 always@(negedge pl_ps_apugic_irq[0])
 begin
  ps8_set_input_pl_ps_apugic_irq(0,0);
end

 always@(posedge pl_ps_apugic_irq[1])
 begin
  ps8_set_input_pl_ps_apugic_irq(1,1);
end

 always@(negedge pl_ps_apugic_irq[1])
 begin
  ps8_set_input_pl_ps_apugic_irq(1,0);
end

 always@(posedge pl_ps_apugic_irq[2])
 begin
  ps8_set_input_pl_ps_apugic_irq(2,1);
end

 always@(negedge pl_ps_apugic_irq[2])
 begin
  ps8_set_input_pl_ps_apugic_irq(2,0);
end

 always@(posedge pl_ps_apugic_irq[3])
 begin
  ps8_set_input_pl_ps_apugic_irq(3,1);
end

 always@(negedge pl_ps_apugic_irq[3])
 begin
  ps8_set_input_pl_ps_apugic_irq(3,0);
end

 import "DPI-C" function void ps8_set_input_pl_ps_apugic_fiq(input int pinIndex, input int pinVlaue);
 always@(posedge pl_ps_apugic_fiq[0])
 begin
  ps8_set_input_pl_ps_apugic_fiq(0,1);
end

 always@(negedge pl_ps_apugic_fiq[0])
 begin
  ps8_set_input_pl_ps_apugic_fiq(0,0);
end

 always@(posedge pl_ps_apugic_fiq[1])
 begin
  ps8_set_input_pl_ps_apugic_fiq(1,1);
end

 always@(negedge pl_ps_apugic_fiq[1])
 begin
  ps8_set_input_pl_ps_apugic_fiq(1,0);
end

 always@(posedge pl_ps_apugic_fiq[2])
 begin
  ps8_set_input_pl_ps_apugic_fiq(2,1);
end

 always@(negedge pl_ps_apugic_fiq[2])
 begin
  ps8_set_input_pl_ps_apugic_fiq(2,0);
end

 always@(posedge pl_ps_apugic_fiq[3])
 begin
  ps8_set_input_pl_ps_apugic_fiq(3,1);
end

 always@(negedge pl_ps_apugic_fiq[3])
 begin
  ps8_set_input_pl_ps_apugic_fiq(3,0);
end
