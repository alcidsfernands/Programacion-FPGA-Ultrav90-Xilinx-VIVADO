...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set dir_sal_0 [ create_bd_port -dir O dir_sal_0 ]
  set ds_data_bus_0 [ create_bd_port -dir IO ds_data_bus_0 ]
  set echo_0 [ create_bd_port -dir I echo_0 ]
  set enable_sal_0 [ create_bd_port -dir O enable_sal_0 ]
  set entrada_0 [ create_bd_port -dir I entrada_0 ]
  set pwm_dc_motor_negro_0 [ create_bd_port -dir O pwm_dc_motor_negro_0 ]
  set pwm_dc_motor_rojo_0 [ create_bd_port -dir O pwm_dc_motor_rojo_0 ]
  set sensor_hall_azul_0 [ create_bd_port -dir I sensor_hall_azul_0 ]
  set sensor_hall_verde_0 [ create_bd_port -dir I sensor_hall_verde_0 ]
  set servo_pwm_0 [ create_bd_port -dir O servo_pwm_0 ]
  set step_0 [ create_bd_port -dir O step_0 ]
  set trigger_0 [ create_bd_port -dir O trigger_0 ]

  # Create instance: MYIP_MOTORDC_DIR_0, and set properties
  set MYIP_MOTORDC_DIR_0 [ create_bd_cell -type ip -vlnv opendeusto.es:user:MYIP_MOTORDC_DIR:1.0 MYIP_MOTORDC_DIR_0 ]

  # Create instance: MY_IP_CONTADOR_21_22_0, and set properties
  set MY_IP_CONTADOR_21_22_0 [ create_bd_cell -type ip -vlnv opendeusto.es:user:MY_IP_CONTADOR_21_22:1.0 MY_IP_CONTADOR_21_22_0 ]

  # Create instance: MY_IP_FILTRO_21_22_0, and set properties
  set MY_IP_FILTRO_21_22_0 [ create_bd_cell -type ip -vlnv opendeusto.es:user:MY_IP_FILTRO_21_22:1.0 MY_IP_FILTRO_21_22_0 ]

  # Create instance: MY_IP_HALL_21_22_0, and set properties
  set MY_IP_HALL_21_22_0 [ create_bd_cell -type ip -vlnv opendeusto.es:user:MY_IP_HALL_21_22:1.0 MY_IP_HALL_21_22_0 ]

  # Create instance: MY_IP_HC_SR04_0, and set properties
  set MY_IP_HC_SR04_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:MY_IP_HC_SR04:1.0 MY_IP_HC_SR04_0 ]

  # Create instance: MY_IP_SERVO_0, and set properties
  set MY_IP_SERVO_0 [ create_bd_cell -type ip -vlnv opendeusto.es:user:MY_IP_SERVO:1.0 MY_IP_SERVO_0 ]

  # Create instance: MY_IP_STEPPER_0, and set properties
  set MY_IP_STEPPER_0 [ create_bd_cell -type ip -vlnv opendeusto.es:user:MY_IP_STEPPER:1.0 MY_IP_STEPPER_0 ]

  # Create instance: PID_IP_0, and set properties
  set PID_IP_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:PID_IP:1.0 PID_IP_0 ]
  ...
  # Create instance: my_ip_temperatura_0, and set properties
  set my_ip_temperatura_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:my_ip_temperatura:1.0 my_ip_temperatura_0 ]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins MY_IP_STEPPER_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins MY_IP_HALL_21_22_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins MY_IP_HC_SR04_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins MYIP_MOTORDC_DIR_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins MY_IP_CONTADOR_21_22_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins MY_IP_FILTRO_21_22_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M06_AXI [get_bd_intf_pins my_ip_temperatura_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M07_AXI [get_bd_intf_pins axi_bram_ctrl_0/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M07_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M09_AXI [get_bd_intf_pins MY_IP_SERVO_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M10_AXI [get_bd_intf_pins PID_IP_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M10_AXI]
  ...
  connect_bd_net -net MYIP_MOTORDC_DIR_0_pwm_dc_motor_negro [get_bd_ports pwm_dc_motor_negro_0] [get_bd_pins MYIP_MOTORDC_DIR_0/pwm_dc_motor_negro]
  connect_bd_net -net MYIP_MOTORDC_DIR_0_pwm_dc_motor_rojo [get_bd_ports pwm_dc_motor_rojo_0] [get_bd_pins MYIP_MOTORDC_DIR_0/pwm_dc_motor_rojo]
  connect_bd_net -net MY_IP_FILTRO_21_22_0_salida_pin [get_bd_pins MY_IP_CONTADOR_21_22_0/entrada] [get_bd_pins MY_IP_FILTRO_21_22_0/salida_pin]
  connect_bd_net -net MY_IP_HC_SR04_0_trigger [get_bd_ports trigger_0] [get_bd_pins MY_IP_HC_SR04_0/trigger]
  connect_bd_net -net MY_IP_SERVO_0_servo_pwm [get_bd_ports servo_pwm_0] [get_bd_pins MY_IP_SERVO_0/servo_pwm]
  connect_bd_net -net MY_IP_STEPPER_0_dir_sal [get_bd_ports dir_sal_0] [get_bd_pins MY_IP_STEPPER_0/dir_sal]
  connect_bd_net -net MY_IP_STEPPER_0_enable_sal [get_bd_ports enable_sal_0] [get_bd_pins MY_IP_STEPPER_0/enable_sal]
  connect_bd_net -net MY_IP_STEPPER_0_step [get_bd_ports step_0] [get_bd_pins MY_IP_STEPPER_0/step]
  connect_bd_net -net Net [get_bd_ports ds_data_bus_0] [get_bd_pins my_ip_temperatura_0/ds_data_bus]
  connect_bd_net -net echo_0_1 [get_bd_ports echo_0] [get_bd_pins MY_IP_HC_SR04_0/echo]
  connect_bd_net -net entrada_0_1 [get_bd_ports entrada_0] [get_bd_pins MY_IP_FILTRO_21_22_0/entrada]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins MYIP_MOTORDC_DIR_0/s00_axi_aresetn] [get_bd_pins MY_IP_CONTADOR_21_22_0/s00_axi_aresetn] [get_bd_pins MY_IP_FILTRO_21_22_0/s00_axi_aresetn] [get_bd_pins MY_IP_HALL_21_22_0/s00_axi_aresetn] [get_bd_pins MY_IP_HC_SR04_0/s00_axi_aresetn] [get_bd_pins MY_IP_SERVO_0/s00_axi_aresetn] [get_bd_pins MY_IP_STEPPER_0/s00_axi_aresetn] [get_bd_pins PID_IP_0/s00_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins my_ip_temperatura_0/s00_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins ps8_0_axi_periph/M09_ARESETN] [get_bd_pins ps8_0_axi_periph/M10_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net sensor_hall_azul_0_1 [get_bd_ports sensor_hall_azul_0] [get_bd_pins MY_IP_HALL_21_22_0/sensor_hall_azul]
  connect_bd_net -net sensor_hall_verde_0_1 [get_bd_ports sensor_hall_verde_0] [get_bd_pins MY_IP_HALL_21_22_0/sensor_hall_verde]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins MYIP_MOTORDC_DIR_0/s00_axi_aclk] [get_bd_pins MY_IP_CONTADOR_21_22_0/s00_axi_aclk] [get_bd_pins MY_IP_FILTRO_21_22_0/s00_axi_aclk] [get_bd_pins MY_IP_HALL_21_22_0/s00_axi_aclk] [get_bd_pins MY_IP_HC_SR04_0/s00_axi_aclk] [get_bd_pins MY_IP_SERVO_0/s00_axi_aclk] [get_bd_pins MY_IP_STEPPER_0/s00_axi_aclk] [get_bd_pins PID_IP_0/s00_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins my_ip_temperatura_0/s00_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/M06_ACLK] [get_bd_pins ps8_0_axi_periph/M07_ACLK] [get_bd_pins ps8_0_axi_periph/M08_ACLK] [get_bd_pins ps8_0_axi_periph/M09_ACLK] [get_bd_pins ps8_0_axi_periph/M10_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MYIP_MOTORDC_DIR_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MY_IP_CONTADOR_21_22_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MY_IP_FILTRO_21_22_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MY_IP_HALL_21_22_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MY_IP_HC_SR04_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MY_IP_SERVO_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MY_IP_STEPPER_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA00A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs PID_IP_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0xA0070000 -range 0x00002000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs my_ip_temperatura_0/S00_AXI/S00_AXI_reg] -force
